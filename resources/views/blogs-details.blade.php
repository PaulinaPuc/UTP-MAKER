    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="#">Detalles del blog</a></span>
            </div>
            <div class="blog-heading about-heading">
                <h1 class="heading">Detalles del Blog</h1>
            </div>
        </div>
    </section>
<!--------------- fin-sección-titulo-blog ---------------->

<!--------------- sección-detalles-blog ---------------->
                    ...
                    <div class="col-lg-8">
                        <div class="blogs-wrapper">
                            ...
                            <div class="wrapper-info">
                                ...
                                <a href="/blogs" class="about-details wrapper-details blog-details-heading">Comercio electrónico (B2C) que
                                    involucra la venta de productos y servicios con envío y transporte de carga
                                </a>
                        ...
                        <div class="blogs-form-section">
                            ...
                            <div class="review-form">
                                ...
                                <div class="review-btn">
                                    <a href="#" class="shop-btn">Enviar reseña</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-5">
                                <div class="col-lg-12">
                                    <div class="blog-post search">
                                        <h5 class="post-details">Buscar</h5>
                                        <hr>
                                ...
                                <div class="col-lg-12">
                                    <div class="blog-post Latest-post">
                                        <h5 class="post-details">Últimas publicaciones</h5>
                                        <hr>
                                        <div class="blogs-wrapper product-wrapper">
                                            ...
                                            <div class="wrapper-info">
                                                <h5 class="about-details wrapper-details">Comercio electrónico (B2C) que
                                                    involucra la venta de productos
                                                </h5>
                                                <div class="wrapper-data">
                                                    <div class="admin wrapper-item">
                                                        <span class="icon">
                                        ...
                                        <div class="blogs-wrapper product-wrapper">
                                            ...
                                            <div class="wrapper-info">
                                                <h5 class="about-details wrapper-details">15 mejores temas de WordPress para periódicos a tener en cuenta en 2022
                                                </h5>
                                                <div class="wrapper-data">
                                                    <div class="admin wrapper-item">
                                                        <span class="icon">
